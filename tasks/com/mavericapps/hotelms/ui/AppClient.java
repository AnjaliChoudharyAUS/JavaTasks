package tasks.com.mavericapps.hotelms.ui;

import tasks.com.mavericapps.hotelms.domain.Guest;
import tasks.com.mavericapps.hotelms.domain.Hotel;
...
public class AppClient {
    public static void main(String[] args) {
        ...
        Hotel hotel = new Hotel("Raddison", demo,1);
        HotelServiceImpl hotelService = new HotelServiceImpl();

        System.out.println("*******************************************************************************");
        System.out.println("Welcome to Raddison Hotel");

        Guest g1 = hotelService.findGuestCheckedInRoom(401);
        System.out.println(" 1) findGuestCheckedInRoom using roomID: " + g1);

        int c1 = hotelService.guestsCount();
        System.out.println(" 2) guestsCount: " + c1);

        double e1 = hotelService.earningToday();
        System.out.println(" 3) earningToday: " + e1);
        System.out.println(" 4) All Guests: ");

        Guest[] ag1 = hotelService.findAllGuest();
